    ...
    private void resetPassword() {
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email)) {
                    Toast.makeText(getApplication(), R.string.msg4, Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                auth.sendPasswordResetEmail(email)
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(LoginActivity.this, R.string.msg5, Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(LoginActivity.this, R.string.msg6, Toast.LENGTH_SHORT).show();
                                }
