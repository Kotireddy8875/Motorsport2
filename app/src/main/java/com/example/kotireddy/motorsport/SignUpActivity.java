                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(SignUpActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toast.makeText(SignUpActivity.this, getString(R.string.msg9) + task.isSuccessful(), Toast.LENGTH_SHORT).show();
                                progressBar.setVisibility(View.GONE);
                                // If sign in fails, display a message to the user. If sign in succeeds
                                // the auth state listener will be notified and logic to handle the
                                // signed in user can be handled in the listener.
                                if (!task.isSuccessful()) {
                                    Toast.makeText(SignUpActivity.this, getString(R.string.msg10) + task.getException(),
    ...
    private void resetPassword() {
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email)) {
                    Toast.makeText(getApplication(), R.string.msg11, Toast.LENGTH_SHORT).show();
                    return;
                }
